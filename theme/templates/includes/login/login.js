...
$(function () {
	...
	$(window).on("hashchange", function () {
		...
		if (window.location.hash == '#forgot') {
			...
			$("section.for-login").hide();
			$("section.for-email-login").hide();
			$("section.for-forgot").show();
			$("section.for-login-with-email-link").hide();
			$("section.for-signup").hide();

		} else if (window.location.hash == '#signup') {

			$("section.for-login").hide();
			$("section.for-email-login").hide();
			$("section.for-forgot").hide();
			$("section.for-login-with-email-link").hide();
			$("section.for-signup").show();
		} else if (window.location.hash == '#login') {
			$("section.for-login").show();
			$("section.for-email-login").hide();
			$("section.for-forgot").hide();
			$("section.for-login-with-email-link").hide();
			$("section.for-signup").hide();
